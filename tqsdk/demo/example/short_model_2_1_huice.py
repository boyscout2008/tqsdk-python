...
1. 它是模型2的延续，在模型2主空破5,10日线，但未中大背离之前且距离支撑有空间的情况下的中大空趋势
2  它也有两种形态：先相对高滞涨转空和直接震荡做空 --- XIANGAO_SHORT 和 
...
logger.info("start zhendang_short_model_2_1 daily strategy for %s in %d.%d.%d!"%(SYMBOL, YEAR, MONTH, DAY))
